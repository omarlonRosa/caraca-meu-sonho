...
('Aurora Boreal na Islândia', 'Reykjavík, Islândia', 'Uma caçada inesquecível pelas luzes...', '2023-12-01', 8, 15500.00, 10, 'https://res.cloudinary.com/.../iceland_qyswub.jpg', false); -- Data no passado

-- Insere os usuários
INSERT INTO usuario (nome, email, senha, roles) VALUES 
('Administrador', 'admin@caracameusonho.com', '$2a$10$c/DeLNNd.MrINbV2mwDNFuaXcEGAyw/lN9.6wAge9CrwPp2W07Uc2', 'ROLE_ADMIN'),
('Marlon Rosa', 'marlonrosapl@gmail.com', '$2a$10$BSB7vWpfX6R8hC9PN6CXaOznz9r0rfKeJNJkQw8zBR9Bf4JHVKci2', 'ROLE_USER'); -- Adicionando seu usuário

-- Insere as reservas para o seu usuário
...
((SELECT id from usuario where email = 'marlonrosapl@gmail.com'), (SELECT id from pacote_viagem where titulo = 'Aurora Boreal na Islândia'), '2023-10-01T15:30:00', 'REALIZADA'); -- Status para viagem passada

-- Insere a configuração do Hero
INSERT INTO hero_config (type, title, subtitle, main_url, active) VALUES
(
    'BANNER',
    'Viaje com o fotógrafo dos seus sonhos.',
    'Quero viver essa experiência',
    'https://res.cloudinary.com/djrzoct2q/image/upload/v1756939987/banner_hero_default_v2_x2k9v0.jpg',
    true
);
